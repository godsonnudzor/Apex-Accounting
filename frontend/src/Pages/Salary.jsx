      ...
      {selectedPayslip && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 p-4 print:static print:overflow-visible print:bg-white print:p-0" role="dialog" aria-modal="true" aria-label="Employee payslip">
          <article className="mx-auto my-8 max-w-2xl bg-white p-6 shadow-2xl print:my-0 print:max-w-none print:p-8 print:shadow-none">
            ...
            <div className="mt-8 border-t border-slate-200 pt-5"><h3 className="mb-3 text-sm font-bold uppercase tracking-wide text-slate-500">Contributions</h3><div className="grid gap-2 sm:grid-cols-4"><PayslipLine label="Employee SSNIT (5.5%)" value={selectedPayslip.entry.ssnitEmployee} /><PayslipLine label="Total SSNIT (13.5%)" value={selectedPayslip.entry.totalSsnitContribution} /><PayslipLine label="Tier 2 (5%)" value={selectedPayslip.entry.tier2Employer} /><PayslipLine label="Employer total (13%)" value={selectedPayslip.entry.totalEmployerContributions} strong /></div></div>
